...
Route::get('/customer-pethotel/info/{id}', [CustomerPetHotelController::class, 'info'])->name('pethotel-info');
...
Route::get('/customer-grooming/info/{id}', [CustomerGroomingController::class, 'info'])->name('grooming-info');
